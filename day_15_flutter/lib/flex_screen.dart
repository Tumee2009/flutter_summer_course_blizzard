  ...
  Widget _buildFooter(BuildContext context) {
    return Center(
      child: Container(
        ...
        child: Padding(padding: const EdgeInsets.symmetric(vertical: 15.0, horizontal: 30), child: Text("Pinned to the Bottom", style: Theme.of(context).textTheme.titleSmall,)),
      ),
    );
  }
}
